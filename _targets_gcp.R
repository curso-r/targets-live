...
tar_option_set(
  ...
  resources = tar_resources(
    gcp = tar_resources_gcp(bucket = "targets-curso-r")
  ),
  repository = "gcp"
)
...
list(
  ...
  tar_target(boxplots_churn_test_train, patchwork::wrap_plots(boxplots_churn_test, boxplots_churn_train), library = "patchwork"),
